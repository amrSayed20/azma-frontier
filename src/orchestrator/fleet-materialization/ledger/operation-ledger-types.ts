 ...
 * File: src/orchestrator/fleet-materialization/ledger/operation-ledger-types.ts
 *
 * The Operation Ledger Contracts.
 * Governs how the Fleet Materialization Runtime tracks, authorizes, and accounts for
 ...
 * The Fleet Materialization Runtime maintains this ledger independently of any project.
 */
...
/**
 * The payload used by the Fleet Materialization Runtime to request authorization from the commercial billing/quota engine.
 */
