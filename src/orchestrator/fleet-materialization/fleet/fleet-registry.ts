 ...
 * File: src/orchestrator/fleet-materialization/fleet/fleet-registry.ts
 *
 * The Fleet Registry implementation.
 * The executable memory layer that categorizes and manages all active
 * IProviderAdapter instances across the Fleet Materialization Runtime's multi-modal ecosystem.
 */
