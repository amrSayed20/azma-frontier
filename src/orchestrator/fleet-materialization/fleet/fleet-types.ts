 ...
 * File: src/orchestrator/fleet-materialization/fleet/fleet-types.ts
 *
 * The Agnostic Fleet & Adapter Contracts.
 * Governs the abstraction layer between the Fleet Materialization Runtime's routing intelligence
...
/**
 * The internal decision matrix output by the Fleet Materialization Runtime's routing logic.
 */
