...
describe('Persistent Storage Foundation — database connection', () => {
  ...
  it('applies the full schema to a freshly created database', () => {
    ...
    expect(tables).toEqual(['cinematic_ledger', 'creators', 'generation_records', 'goals', 'observations', 'operation_ledger', 'sessions', 'sovereign_canvases', 'subscriptions', 'vault_assets']);
    db.close();
  });
